        ...
        <div className="relative max-w-screen-xl mx-auto ">
          <div className="firstSection lg:flex">
            <section className="data md:w-8/12">
              ...
              <p className="text-lg md:text-xl pt-4">Is there any prospect for me? Reach me at my <a href="aswinjitht5@gmail.com">e-mail</a></p>
              <button className="text-lg md:text-xl mt-5 py-2 px-4 rounded-lg bg-black text-white border">Download my CV</button>
            </section>
